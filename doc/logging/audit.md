...
| `BUDGET_CREATED` | Budget | `CREATE` | `BUDGET_CREATE_SUCCESS` |
| `BUDGET_UPDATED` | Budget | `UPDATE` | `BUDGET_UPDATE_SUCCESS` |
| `BUDGET_DELETED` | Budget | `DELETE` | `BUDGET_DELETE_SUCCESS` |
| `SAVINGS_GOAL_CREATED` | SavingsGoal | `CREATE` | `SAVINGS_GOAL_CREATE_SUCCESS` |
| `SAVINGS_GOAL_UPDATED` | SavingsGoal | `UPDATE` | `SAVINGS_GOAL_UPDATE_SUCCESS` |
| `SAVINGS_GOAL_DELETED` | SavingsGoal | `DELETE` | `SAVINGS_GOAL_DELETE_SUCCESS` |
...
| `INSTALLMENT_PAYMENT_UNDONE` | Installment | `PAYMENT_UNDO` | `INSTALLMENT_UNPAY_SUCCESS` |
