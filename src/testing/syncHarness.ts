...
const ROUTE_DEFS: Array<{ pattern: string; load: Loader }> = [
  ...
  { pattern: "/api/admin/license", load: () => import("@/app/api/admin/license/route") },
  { pattern: "/api/admin/logging", load: () => import("@/app/api/admin/logging/route") },
  { pattern: "/api/admin/health", load: () => import("@/app/api/admin/health/route") },
  { pattern: "/api/admin/logs", load: () => import("@/app/api/admin/logs/route") },
  { pattern: "/api/metrics", load: () => import("@/app/api/metrics/route") },
  { pattern: "/api/admin/release", load: () => import("@/app/api/admin/release/route") },
  ...
  { pattern: "/api/reports", load: () => import("@/app/api/reports/route") },
  { pattern: "/api/reports/category-calendar", load: () => import("@/app/api/reports/category-calendar/route") },
  { pattern: "/api/capital", load: () => import("@/app/api/capital/route") },
  { pattern: "/api/dashboard", load: () => import("@/app/api/dashboard/route") },
