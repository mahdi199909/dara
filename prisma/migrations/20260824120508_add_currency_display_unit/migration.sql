...
INSERT INTO "new_Settings" ("calendarType", "createdAt", "currency", "dashboardCardPrefs", "hourlyValueOverride", "id", "monthlyIncome", "timezone", "updatedAt", "userId", "workingHoursMonth") SELECT "calendarType", "createdAt", "currency", "dashboardCardPrefs", "hourlyValueOverride", "id", "monthlyIncome", "timezone", "updatedAt", "userId", "workingHoursMonth" FROM "Settings";
DROP TABLE "Settings";
